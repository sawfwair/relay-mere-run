...
const submitJobRequestObjectSchema = z.object({
  ...
  variant: z.enum(['distilled', 'unified-av']).optional(),
  guidance_scale: z.number().optional(),
  shift: z.number().optional(),
  adapter_selections: z.array(z.object({}).passthrough()).optional(),
  continuity: z.object({ mode: z.string() }).passthrough().optional(),
